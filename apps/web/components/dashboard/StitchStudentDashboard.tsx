...
import { Button, Badge, Card, Modal } from "@campusos/ui";
    ...
    <div className="flex flex-col w-full gap-5">
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-[var(--surface)] border border-[var(--border-subtle)] p-4 rounded-xl shadow-xs">
          <div className="flex items-center gap-3.5">
            <div className="relative flex items-center justify-center w-11 h-11 rounded-lg bg-[var(--brand-indigo-subtle)] border border-[var(--brand-indigo-subtle)] text-[var(--brand-indigo)] shadow-xs">
              <span className="material-symbols-outlined text-2xl">school</span>
              <span className="absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-[var(--status-success)] ring-2 ring-[var(--surface)]"></span>
            </div>
            <div>
          ...
          <div className="flex items-center gap-2 self-start md:self-center">
            <div className="flex items-center gap-1.5 bg-[var(--surface-raised)] border border-[var(--border-subtle)] px-3 py-1.5 rounded-lg text-[var(--text-secondary)] text-xs font-medium">
              <span className="w-2 h-2 rounded-full bg-[var(--status-success)]"></span>
              <span>Term W7 • Day 44/90</span>
            </div>
            <button
              onClick={handleSyncLms}
              className="flex items-center gap-1.5 bg-[var(--surface)] hover:bg-[var(--surface-raised)] border border-[var(--border-interactive)] text-[var(--text-primary)] px-3 py-1.5 rounded-lg text-xs font-medium transition-colors shadow-xs focus-ring"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          {/* Attendance KPI */}
          <div className="flex flex-col justify-between bg-[var(--surface)] border border-[var(--border-subtle)] p-4 rounded-xl shadow-xs hover:border-[var(--border-interactive)] transition-all duration-150">
            <div className="flex items-center justify-between">
              <span className="text-[10px] uppercase tracking-wider text-[var(--text-muted)] font-bold">
                Overall Attendance
              </span>
              <div className="w-7 h-7 rounded-md bg-[var(--status-success-surface)] flex items-center justify-center text-[var(--status-success)]">
                <span className="material-symbols-outlined text-lg">fact_check</span>
              </div>
            </div>
            <div className="mt-3 flex items-baseline gap-2">
              <span className="text-2xl font-bold font-mono text-[var(--status-success)]">94.8%</span>
          ...
          <div className="flex flex-col justify-between bg-[var(--surface)] border border-[var(--border-subtle)] p-4 rounded-xl shadow-xs hover:border-[var(--border-interactive)] transition-all duration-150">
            <div className="flex items-center justify-between">
              ...
              <div className="w-7 h-7 rounded-md bg-[var(--brand-indigo-subtle)] flex items-center justify-center text-[var(--brand-indigo)]">
          ...
          <div className="flex flex-col justify-between bg-[var(--surface)] border border-[var(--border-subtle)] p-4 rounded-xl shadow-xs hover:border-[var(--border-interactive)] transition-all duration-150">
            <div className="flex items-center justify-between">
              ...
              <div className="w-7 h-7 rounded-md bg-[var(--status-warning-surface)] flex items-center justify-center text-[var(--status-warning)]">
                <span className="material-symbols-outlined text-lg">pending_actions</span>
              </div>
            </div>
            <div className="mt-3 flex items-baseline gap-2">
              <span className="text-2xl font-bold font-mono text-[var(--status-warning)]">3 Due</span>
              <span className="text-xs text-[var(--text-muted)]">this week</span>
            </div>
            <div className="mt-2.5 pt-2 border-t border-[var(--border-subtle)] flex items-center justify-between text-xs text-[var(--text-muted)]">
              <span className="truncate">CS 341 Lab 3 in <strong className="text-[var(--status-warning)] font-medium">14h</strong></span>
          ...
          <div className="flex flex-col justify-between bg-[var(--surface)] border border-[var(--border-subtle)] p-4 rounded-xl shadow-xs hover:border-[var(--border-interactive)] transition-all duration-150">
            <div className="flex items-center justify-between">
              ...
              <div className="w-7 h-7 rounded-md bg-[var(--status-info-surface)] flex items-center justify-center text-[var(--status-info)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        ...
        <div className="lg:col-span-8 flex flex-col gap-5 min-w-0">
          ...
          {!bannerDismissed && (
            <div className="relative overflow-hidden bg-[var(--brand-indigo-subtle)] border border-[var(--brand-indigo-subtle)] p-4 rounded-xl shadow-xs">
              <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[var(--brand-indigo)] to-[var(--status-info)]"></div>
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 pt-1">
                <div className="flex items-start gap-3.5">
                  <div className="w-9 h-9 shrink-0 rounded-lg bg-[var(--brand-indigo-subtle)] border border-[var(--brand-indigo-subtle)] flex items-center justify-center text-[var(--brand-indigo)] shadow-xs">
                  ...
                  <div>
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2">
                      <Button
                        ...
                        leftIcon={<span className="material-symbols-outlined text-sm">bolt</span>}
                      >
                        Review Flash Summary (4m)
                      </Button>
                      <Button
                        size="xs"
                        variant="secondary"
                        onClick={() => setActiveTab("ai")}
                        leftIcon={<span className="material-symbols-outlined text-sm text-[var(--text-muted)]">quiz</span>}
                      >
                        Practice 5 Mock Questions
                      </Button>
                ...
                <button
                  ...
                  className="self-start text-[var(--text-muted)] hover:text-[var(--text-primary)] p-1 rounded-md transition-colors focus-ring"
          ...
          <section className="bg-[var(--surface)] border border-[var(--border-subtle)] p-5 rounded-xl shadow-xs flex flex-col gap-4">
            ...
            <div className="space-y-3">
              {/* Live Item: CS 341 */}
              <div className="relative bg-[var(--surface-raised)] border border-[var(--status-success-border)] p-4 rounded-lg shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3 overflow-hidden">
                <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[var(--status-success)]"></div>
                <div className="flex items-start gap-3.5 pl-1">
                  ...
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span className="flex items-center gap-1.5 bg-[var(--status-success-surface)] border border-[var(--status-success-border)] text-[var(--status-success)] px-2 py-0.5 rounded text-[11px] font-semibold font-mono">
                        <span className="w-1.5 h-1.5 rounded-full bg-[var(--status-success)] animate-ping"></span>
                        Starts in 35m
                      </span>
                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-3 text-xs text-[var(--text-muted)]">
                      ...
                      <span>•</span>
                      <span className="text-[var(--status-success)] font-medium">Bluetooth Beacon in Range</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                  <Button
                    ...
                    leftIcon={<span className="material-symbols-outlined text-sm text-[var(--text-muted)]">directions</span>}
                  >
                    Room Map
                  </Button>
                  <Button
                    size="xs"
                    variant={bleCheckedIn ? "secondary" : "success"}
                  ...
                  >
                    {bleCheckedIn ? "Checked In!" : bleLoading ? "Verifying BLE..." : "One-Tap Check-in"}
                  </Button>
                </div>
              </div>
              ...
              <div className="bg-[var(--surface)] border border-[var(--border-subtle)] hover:border-[var(--border-interactive)] p-4 rounded-lg shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-colors">
                ...
                <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                  <Button
                    ...
                    variant="secondary"
                    onClick={() => setActiveTab("timetable")}
                    leftIcon={<span className="material-symbols-outlined text-sm text-[var(--text-muted)]">menu_book</span>}
                  >
                    Open Slides
                  </Button>
                </div>
          ...
          <section className="bg-[var(--surface)] border border-[var(--border-subtle)] p-5 rounded-xl shadow-xs flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-[var(--status-success)] text-xl">table_chart</span>
                ...
                <tbody className="divide-y divide-[var(--border-subtle)] bg-[var(--surface)]">
                  <tr className="hover:bg-[var(--surface-hover)] transition-colors">
                    ...
                    <td className="py-3 px-4 min-w-[140px]">
                      <div className="flex items-center gap-2">
                        <div className="w-20 bg-[var(--surface-raised)] border border-[var(--border-subtle)] h-2 rounded-full overflow-hidden">
                          <div className="bg-[var(--status-success)] h-full rounded-full w-[96%]"></div>
                        </div>
                        <span className="font-semibold font-mono text-[var(--status-success)] text-xs">96.0%</span>
                      </div>
                    ...
                    <td className="py-3 px-4 text-right">
                      <button
                        ...
                        className="p-1.5 rounded-md text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-raised)] transition-colors focus-ring"
                  ...
                  <tr className="hover:bg-[var(--surface-hover)] transition-colors">
                    ...
                    <td className="py-3 px-4 min-w-[140px]">
                      <div className="flex items-center gap-2">
                        <div className="w-20 bg-[var(--surface-raised)] border border-[var(--border-subtle)] h-2 rounded-full overflow-hidden">
                          <div className="bg-[var(--status-success)] h-full rounded-full w-[92%]"></div>
                        </div>
                        <span className="font-semibold font-mono text-[var(--status-success)] text-xs">92.0%</span>
                      </div>
        ...
        <div className="lg:col-span-4 flex flex-col gap-5">
          ...
          <section className="bg-[var(--surface)] border border-[var(--border-subtle)] p-4 rounded-xl shadow-xs flex flex-col gap-2.5">
            ...
            <div className="grid grid-cols-1 gap-2">
              <button
                ...
                className="w-full flex items-center justify-between bg-[var(--surface-raised)] hover:bg-[var(--surface-hover)] border border-[var(--border-subtle)] p-2.5 rounded-lg text-left transition-all duration-150 group focus-ring"
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-md bg-[var(--status-success-surface)] border border-[var(--status-success-border)] flex items-center justify-center text-[var(--status-success)]">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-md bg-[var(--brand-indigo-subtle)] border border-[var(--brand-indigo-subtle)] flex items-center justify-center text-[var(--brand-indigo)]">
          ...
          <section className="bg-[var(--surface)] border border-[var(--border-subtle)] p-4 rounded-xl shadow-xs flex flex-col gap-3.5">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-[var(--status-success)] text-xl">radar</span>
            ...
            <div className="rounded-lg overflow-hidden bg-[var(--surface-raised)] border border-[var(--border-subtle)] shadow-xs flex flex-col">
              <div className="p-3.5 flex flex-col gap-2">
                ...
                <div className="mt-1 flex items-center justify-between pt-2 border-t border-[var(--border-subtle)]">
                  <span className="text-[11px] text-[var(--status-success)] font-mono font-medium">Oct 15 - 16</span>
                  <Button
                    size="xs"
                    variant="primary"
          ...
          <div className="bg-[var(--surface)] border border-[var(--border-subtle)] p-4 rounded-xl shadow-xs flex flex-col gap-2">
            ...
            <div className="mt-1 space-y-2 text-xs">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[var(--status-success)] font-medium font-mono text-[11px]">Low Density (24%)</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-[var(--text-secondary)] flex items-center gap-2">
                ...
                <span className="text-[var(--status-warning)] font-medium font-mono text-[11px]">Queue &lt; 2 mins</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <Modal
        ...
        maxWidth="sm"
        title={
          <span className="uppercase tracking-wider text-[var(--status-success)] font-bold text-xs font-mono">
            Dynamic Student ID
          </span>
        }
      >
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center justify-center gap-1.5 mt-2 text-[var(--status-success)] text-xs font-mono bg-[var(--status-success-surface)] border border-[var(--status-success-border)] py-1 px-2.5 rounded-full">
              <span className="w-2 h-2 rounded-full bg-[var(--status-success)] animate-ping"></span>
